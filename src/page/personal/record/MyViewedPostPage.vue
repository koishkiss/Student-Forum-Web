...
<div class="collections">
    <el-text  class="page-title" tag="p" >浏览记录</el-text>
    <div v-if="loading" class="loading">
        加载中...
    </div>

    <div v-if="!hasData" class="no-data">
        <el-empty :image-size="100" description="还没有浏览过帖子呢"/>
    </div>
...
<script lang="ts" setup name="ViewHistory">
...
const fetchCollections = async () => {
    ...
    try {
        const response = await axios.get(`${ip_port}/post/get/viewed`, {
            headers,
